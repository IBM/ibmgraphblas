...
static 
GrB_Info GrB_Matrix_reduce_common
(
    void                    *val,
    GrB_Type                type,
...
{
    return GrB_Matrix_reduce_common(val,GrB_BOOL,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_INT8,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_UINT8,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_INT16,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_UINT16,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_INT32,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_UINT32,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_INT64,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_UINT64,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_FP32,accum,op,A,desc);
}
...
{
    return GrB_Matrix_reduce_common(val,GrB_FP64,accum,op,A,desc);
}
...
{
    if ((!A)     || (A     == GrB_INVALID_HANDLE)) return GrB_UNINITIALIZED_OBJECT;
    return GrB_Matrix_reduce_common(val,A->D(),accum,op,A,desc);
}
